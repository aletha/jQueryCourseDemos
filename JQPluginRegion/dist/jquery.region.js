    ...
    regionSelector: {
        ...
        bind: function() {
            this.reset();
                ...
                jQuery('select[data-region-src="continent"]')
                    .append('<option></option>')
                    .append('<option>Europe</option>')
                    .append('<option>North America</option>')
                    .append('<option>Africa</option>')
                    .append('<option>Asia</option>') 
                    .append('<option>South America</option>')
                    .append('<option>Antartica</option>');
            ...
            jQuery('select[data-region-src="continent"]')
                ...
                .on('change', function(e) {
                    jQuery('select[data-region-src="country"]').empty();
